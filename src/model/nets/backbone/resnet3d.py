...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_stride, BatchNorm):
        ...
        # Modules
        self.conv1 = nn.Conv3d(1, 64, kernel_size=7, stride=(1, 2, 2), padding=(3, 3, 3),
                                bias=False)
...
if __name__ == "__main__":
    import torch
    model = ResNet50(BatchNorm=nn.BatchNorm3d, output_stride=8)
    input = torch.rand(1, 192, 192, 48)
